...
const MAT_MAP: Record<string, string> = {
  ...
  "Сравнение (своя команда)": "Сравнение (свои дауны)",
  "Сравнение (чужая команда)": "Сравнение (чужие дуаны)",
  "Сравнение (своя vs чужая)": "Сравнение (свои vs чужие)",
  "MVP": "MVP",
  "Как считается MVP": "Как считается MVP",
  "Голосование завершится через": "Голосованию пизда через",
  "Текущий лидер": "Сейчас ебарь",
  "Пока нет голосов": "Пока нихуя нет голосов",
  "Гол + пас": "Гол + пас (прокнуло)",
  "Голы": "Голы (запихал)",
  "Ассисты": "Ассисты",
  "Пока нет данных": "Пока нихуя нет",
  "Главное — голоса за MVP. У кого их больше, тот и лидер.": "Главное — голоса за MVP: у кого больше, тот батя.",
  "Если голоса равны, сравниваются полезные действия: голы + ассисты.": "Если поровну — считаем голы+пасы.",
  "Если и это равно, выше тот, у кого больше голов.": "Если и тут поровну — решают голы."
};
