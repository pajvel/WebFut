...
const MAT_MAP: Record<string, string> = {
  ...
  "MVP": "Царь горы",
  "Как считается MVP": "Как считается царь горы",
  "Голосование завершится через": "Голосование сдохнет через",
  "Текущий лидер": "Сейчас рулит",
  "Пока нет голосов": "Пока нихуя нет голосов",
  "Гол + пас": "Гол + пас (разъёб)",
  "Голы": "Голы (вколотил)",
  "Ассисты": "Ассисты (раздал)",
